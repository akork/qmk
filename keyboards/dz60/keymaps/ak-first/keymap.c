...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
	...
	(_______,          _______, _______, G(_B),   _SCL,    _______, _______, _______, G(S(_W)),G(_P),   G(S(_E)),CX_3,    HYPR(_LBR),_______,HYPR(_RBR),
	 _______,          _______, _______, _______, _______, S(_F6),           CX_G, G(C(S(_J))),HYPR(_O),HYPR(_1),HYPR(_RBR),HYPR(_G),_______, CX_LBRC,
