...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
  {
   ...
   LAYOUT // -eMETA 10
   (_______,          _______, _______, _______, _______, _______, _______, _______,A(_BSP),  S(_LBR), BRACES,  EENTER,  _______, _______, _______,
    _______,          C(_K),   _______, G(_Z),   GBSP,    _______,          EENTER,  _PGDN,   _DN,     _UP,     _PGUP,   S(_RBR), _______, _______,
    _______,          EENTER,  C(_D),   A(_U),   _______, _______,          G(_LT),  _BSP,    _RT,     A(_RT),  G(_RT),  A(_D),            _______,
